...
- (void)updateTextFieldFromElement {
    ...
    _textField.text = [_numberFormatter stringFromNumber:el.floatNumber];
}
...
- (void)updateElementFromTextField:(NSString *)value {
    ...
    [self decimalElement].floatNumber = [NSNumber numberWithFloat:(float) (parsedValue / pow(10, [self decimalElement].fractionDigits))];
}
